...
public class Main
{
    public static void main( String[] args ) {
        System.out.println("****** Creating new company EL Barto that sells U.S. kegs " +
                "for $200. ******");
        ...
        System.out.println("****** New customers, Louie and Adil, have just initialized a monthly order " +
                "to El Barto. ******");
        order.addObserver(inCustomer1);
        order.addObserver(inCustomer2);
        order.setPrice(225);

        System.out.println("\n****** Customer Adil has cancelled his order " +
                "from El Barto. ******");
